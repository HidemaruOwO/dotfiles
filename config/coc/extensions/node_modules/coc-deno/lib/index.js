...
var DenoTextDocumentContentProvider = class {
  ...
  provideTextDocumentContent(uri, token) {
    ...
    if (res.startsWith("file:")) {
      PATCH_8_2_3468 = true;
      res = res.replace(`file://${process.cwd()}/`, "").replace("%3A", ":");
    }
    ...
    return this.client.sendRequest(virtualTextDocument, { textDocument: { uri: res } }, token);
  }
};
async function tryActivate(context) {
  ...
  client = new import_coc3.LanguageClient(EXTENSION_NS, run, clientOptions);
  ...
  context.subscriptions.push(import_coc3.workspace.onDidChangeConfiguration((evt) => {
    if (evt.affectsConfiguration(EXTENSION_NS)) {
      ...
      import_coc3.commands.executeCommand("deno.restart");
    }
  ...
  serverVersion = ((_c = (_b = (_a = client.initializeResult) == null ? void 0 : _a.serverInfo) == null ? void 0 : _b.version) != null ? _c : "").split(" ")[0];
  if (serverVersion) {
...
async function activate(context) {
  ...
  if (!enable) {
    context.subscriptions.push(import_coc3.commands.registerCommand(`${EXTENSION_NS}.initializeWorkspace`, async () => {
      await doInitialize();
